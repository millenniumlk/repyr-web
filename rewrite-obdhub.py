...
import { Search, ChevronRight, Gauge, Wrench, Car, Cpu } from 'lucide-react';
...
with open("src/pages/OBDHub.tsx", "w", encoding="utf-8") as f:
    f.write(content)
print("Updated OBDHub.tsx successfully")
